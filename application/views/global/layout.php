...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Sistem Informasi Perpustakaan | SMABA</title>
            ...
            <nav class="teal darken-2">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/smaba.png" width="45px" alt=""></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/smaba.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">PERPUSTAKAAN SMAN 1 BANGSAL</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/bkgsma1.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ICT &copy; : <a href="https://sman1bangsal.sch.id/" target="_blank">SMAN 1 BANGSAL</a>
                </div>
